...
// Delivery zones with real Curacao neighborhood descriptions and coordinates
const deliveryZones = [
  {
    name: 'Zone 1 — Centro',
    color: '#27ae60',
      ...
      <section style={{ padding: '60px 0' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 20px' }}>
          ...
          <p style={{ textAlign: 'center', color: 'var(--dark-warmth)', marginBottom: '40px', maxWidth: '600px', margin: '0 auto 40px' }}>
            We deliver to every corner of Curacao. Check your zone and delivery fee below.
          </p>
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '24px', marginBottom: '5px' }}>
              Free Delivery on Orders Over <span style={{ color: 'var(--muted-gold)' }}>XCG {DELIVERY.freeShippingThreshold}</span>
            </h2>
            <p style={{ color: 'rgba(255,255,255,0.7)' }}>All zones — no exceptions</p>
          </div>

          {/* Curacao Map — OpenStreetMap embed */}
          <div style={{ marginBottom: '40px' }}>
            ...
            <div style={{
              borderRadius: '12px', overflow: 'hidden', border: '2px solid var(--border-light)',
              boxShadow: '0 4px 20px rgba(0,0,0,0.08)', height: '350px'
            }}>
              <iframe
                title="Curacao Delivery Map"
                src="https://www.openstreetmap.org/export/embed.html?bbox=-69.2%2C12.04%2C-68.7%2C12.4&layer=mapnik&marker=12.1696%2C-68.9900"
                style={{ width: '100%', height: '100%', border: 'none' }}
                loading="lazy"
              />
            </div>
            <p style={{ fontSize: '12px', color: 'var(--text-tertiary)', marginTop: '8px', textAlign: 'right' }}>
              <a href="https://www.openstreetmap.org/#map=12/12.17/-68.99" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--muted-gold)' }}>
                View larger map
              </a>
            </p>
          </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: '12px', color: 'var(--dark-warmth)', margin: 0 }}>
                        <i className="fas fa-clock" style={{ marginRight: '4px' }}></i>{zone.time}
                      </p>
                    </div>
                  </div>
                  <span style={{
          ...
          <div style={{
            ...
            {deliveryZones.map(zone => (
              <div key={zone.name} style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px' }}>
                <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: zone.color }}></div>
                <span>{zone.name.split('—')[0].trim()}: <strong>{zone.label}</strong></span>
              </div>
            ))}
          </div>
          ...
          <div style={{
            ...
            <ul style={{ fontSize: '14px', lineHeight: '2', paddingLeft: '20px', color: 'var(--charcoal)', margin: 0 }}>
              ...
              <li>Free delivery applies to all zones for orders over XCG {DELIVERY.freeShippingThreshold}</li>
            </ul>
          </div>
