...
function transformProduct(strapiProduct) {
  ...
  return {
    ...
    gender: attrs.gender,
    fragranceFamily: attrs.fragranceFamily,
    scentProfile: attrs.scentProfile,
    intensity: attrs.intensity,
    occasion: attrs.occasion,
    season: attrs.season,
    topNotes: attrs.topNotes,
    middleNotes: attrs.middleNotes,
    baseNotes: attrs.baseNotes,
    volume: attrs.volume,
    concentration: attrs.concentration,
    // Skincare fields
    skinType: attrs.skinType,
    skinConcern: attrs.skinConcern,
    applicationArea: attrs.applicationArea,
    texture: attrs.texture,
    keyIngredients: attrs.keyIngredients,
    spf: attrs.spf,
    dermatologistTested: attrs.dermatologistTested,
    routineStep: attrs.routineStep,
    timeOfUse: attrs.timeOfUse,
...
export async function fetchBusinessSettings() {
  ...
  try {
    ...
    return {
      ...
      currency: attrs.currency || 'XCG',
      currencySymbol: attrs.currencySymbol || 'XCG',
