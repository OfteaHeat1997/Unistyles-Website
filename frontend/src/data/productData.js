...
export const products = {
  ...
  cremas: {
    ...
    products: [
      // Cyzone
      { id: 'CRM-005', ref: 'Autenti-K', name: 'Perfumada Autenti-K Body Cream', price: 25, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Perfumada Autenti-K Body Cream.jpeg', brand: 'Cyzone', category: 'Body' },
      // Esika
      { id: 'CRM-007', ref: 'Bronze Luminosa', name: 'Hidratante Bronze Luminosa', price: 25, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Hidratante Bronze Luminosa.jpeg', brand: 'Esika', category: 'Body' },
      { id: 'CRM-008', ref: 'Gold Luminosa', name: 'Hidratante Gold Luminosa', price: 25, stockQuantity: 2, inStock: true, image: '/images/catalogo  cremas/Hidratante Gold Luminosa.jpg', brand: 'Esika', category: 'Body' },
      { id: 'CRM-010', ref: 'Bela', name: 'Perfumada Bela Body Cream', price: 25, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Perfumada Bela Body Cream esika.jpg', brand: 'Esika', category: 'Body' },
      { id: 'CRM-011', ref: 'Limage', name: 'Perfumada Limage Body Cream', price: 25, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Perfumada Limage Body Cream.jpg', brand: 'Esika', category: 'Body' },
      { id: 'CRM-012', ref: 'Vibranza', name: 'Perfumada Vibranza Body Cream', price: 25, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Perfumada Vibranza Body Cream esika.jpg', brand: 'Esika', category: 'Body' },
      { id: 'CRM-014', ref: 'Triple Accion 25+', name: 'Triple Accion 25+ Max Collagen Biotin', price: 35, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Triple Accion 25+ Max Collagen Biotin.jpg', brand: 'Esika', category: 'Face' },
      { id: 'CRM-015', ref: 'Triple Accion 40+', name: 'Triple Accion 40+ Max Perfect Tone', price: 35, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Triple Accion 40+ Max  esika.jpg', brand: 'Esika', category: 'Face' },
      { id: 'CRM-016', ref: 'Triple Accion Anti-Imperfecciones', name: 'Triple Accion Max Anti-Imperfecciones', price: 35, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Triple Accion 55+ Max Repair esika.jpg', brand: 'Esika', category: 'Face' },
      { id: 'CRM-017', ref: 'Triple Accion Aclarant', name: 'Triple Accion Aclarant', price: 35, stockQuantity: 4, inStock: true, image: '/images/catalogo  cremas/Triple Accion Brightening Nacar esika.jpg', brand: 'Esika', category: 'Face' },
      { id: 'CRM-018', ref: 'Triple Accion Body 1L', name: 'Triple Accion Max Body Cream 1L', price: 60, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Triple Accion Max Body Cream.jpg', brand: 'Esika', category: 'Body' },
      { id: 'CRM-MN1', ref: 'Multicrem 1L', name: 'Multicrem Nutrients 1L', price: 60, stockQuantity: 2, inStock: true, image: '/images/catalogo  cremas/Multicrem Nutrients Body Cream esika.jpg', brand: 'Esika', category: 'Body' },
      { id: 'CRM-019', ref: 'Triple Accion Deo', name: 'Triple Accion Max Collagen Deo Cream', price: 35, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Triple Accion Max Collagen Deo Cream.jpg', brand: 'Esika', category: 'Body' },
      // L'Bel
      { id: 'CRM-023', ref: 'Chic', name: 'Perfumada Chic Body Cream', price: 25, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Perfumada Chic Body Cream.jpg', brand: "L'Bel", category: 'Body' },
      { id: 'CRM-025', ref: 'Mithyka Lumiere', name: 'Perfumada Mithyka Lumiere Body Cream', price: 25, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Perfumada Mithyka Lumiere Body Cream.jpg', brand: "L'Bel", category: 'Body' },
      { id: 'CRM-026', ref: 'Mithyka Hand', name: 'Perfumada Mithyka Hand Cream', price: 25, stockQuantity: 2, inStock: true, image: '/images/catalogo  cremas/Perfumada Mithyka Hand Cream.jpg', brand: "L'Bel", category: 'Hand' },
      { id: 'CRM-027', ref: 'Mithyka Elixir Hand', name: 'Perfumada Mithyka Elixir Hand Cream', price: 25, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Perfumada Mithyka Elixir Hand Cream.jpg', brand: "L'Bel", category: 'Hand' },
      { id: 'CRM-028', ref: 'Mon', name: 'Perfumada Mon Face Cream', price: 25, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Perfumada Mon Face Cream.jpeg', brand: "L'Bel", category: 'Face' },
      { id: 'CRM-029', ref: 'Satin Rouge', name: 'Perfumada Satin Rouge Face Cream', price: 25, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/L_bel-Satin-Rouge-Locion-Perfumada-L_BEL-USA-5638612.jpg', brand: "L'Bel", category: 'Face' },
      // Yanbal
      { id: 'CRM-032', ref: 'Ccori Oro', name: 'Ccori Oro Body Cream', price: 40, stockQuantity: 0, inStock: false, image: '/images/catalogo  cremas/Ccori Oro Body Cream.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-033', ref: 'Ccori Rose', name: 'Ccori Rose Body Cream', price: 40, stockQuantity: 2, inStock: true, image: '/images/catalogo  cremas/Ccori Rose Body Cream.jpeg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-034', ref: 'Gaia', name: 'Gaia Body Cream', price: 40, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Gaia Body Cream.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-036', ref: 'Osadia', name: 'Osadia Body Cream', price: 40, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Osadia Body Cream.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-037', ref: 'Seda Ambar', name: 'Seda Ambar y Miel Body Cream', price: 40, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Seda Ambar y Miel Body Cream.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-038', ref: 'Seda Perlas', name: 'Seda Perlas y Rosas Body Cream 210g', price: 40, stockQuantity: 2, inStock: true, image: '/images/catalogo  cremas/Seda Perlas y Rosas Body Cream 210g.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-046', ref: 'Temptation Mystic', name: 'Temptation Mystic Body Cream 200ml', price: 40, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Temptation Mystic Body Cream 200ml yanbal.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-048', ref: 'Totalist Avocado', name: 'Totalist Avocado Face Cream', price: 40, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Totalist Avocado Face Cream.jpg', brand: 'Yanbal', category: 'Face' },
      { id: 'CRM-049', ref: 'Totalist Nacar', name: 'Totalist Nacar Brightening 100ml', price: 40, stockQuantity: 2, inStock: true, image: '/images/catalogo  cremas/Totalist Nacar Brightening 100ml.jpg', brand: 'Yanbal', category: 'Face' },
      { id: 'CRM-BM1', ref: 'Biomilk Hidratacion', name: 'Biomilk Hidratacion Moisturizing 750ml', price: 60, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Gaia Body Cream.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'CRM-BM2', ref: 'Biomilk Sensitive', name: 'Biomilk Sensitive Piel Sensible', price: 60, stockQuantity: 1, inStock: true, image: '/images/catalogo  cremas/Gaia Body Cream.jpg', brand: 'Yanbal', category: 'Body' }
    ]
  },
  ...
  bloqueador: {
    ...
    products: [
      { id: 'BLQ-001', ref: 'Defense Total', name: 'Defense Total Protector Solar FPS 50', price: 35, stockQuantity: 0, inStock: false, image: '/images/L_bel-Defense-Total-Protector-solar-50_-FPS-lbel.png', brand: "L'Bel", category: 'Tinted' },
      { id: 'BLQ-002', ref: 'Triple Action SPF 100', name: 'Triple Action Max Anti-aging FPS 100', price: 30, stockQuantity: 1, inStock: true, image: '/images/esuka Triple Action Max Anti-aging FPS 100.png', brand: 'Esika', category: 'Facial' },
      { id: 'BLQ-003', ref: 'Total Block 140g', name: 'Total Block SPF 50+ 140g', price: 140, stockQuantity: 1, inStock: true, image: '/images/Total Block 140g.png', brand: 'Yanbal', category: 'Body' },
      { id: 'BLQ-004', ref: 'Compact Light', name: 'Total Block Compact Beige Claro', price: 75, stockQuantity: 1, inStock: true, image: '/images/Total Block Compact Beige Claro.png', brand: 'Yanbal', category: 'Tinted' },
      { id: 'BLQ-005', ref: 'Compact Dark', name: 'Total Block Compact Beige Oscuro', price: 75, stockQuantity: 0, inStock: false, image: '/images/Total Block Compact Beige Oscuro.jpg', brand: 'Yanbal', category: 'Tinted' },
      { id: 'BLQ-006', ref: 'Compact Nude', name: 'Total Block Compact Nude', price: 75, stockQuantity: 2, inStock: true, image: '/images/Total Block Compact Nude.png', brand: 'Yanbal', category: 'Tinted' },
      { id: 'BLQ-007', ref: 'Matt 80g', name: 'Total Block Matt Matificante 80g', price: 70, stockQuantity: 1, inStock: true, image: '/images/Total Block Matt Matificante 80g.jpg', brand: 'Yanbal', category: 'Facial' },
      { id: 'BLQ-008', ref: 'Spray', name: 'Total Block 50+ Bifasico Spray', price: 80, stockQuantity: 1, inStock: true, image: '/images/Total Block 50+ Bifasico Spray.jpeg', brand: 'Yanbal', category: 'Spray' },
      { id: 'BLQ-009', ref: 'Total Block 80g', name: 'Total Block 80g', price: 70, stockQuantity: 4, inStock: true, image: '/images/Total Block 80g 50fps.jpeg', brand: 'Yanbal', category: 'Body' },
      { id: 'BLQ-010', ref: 'Total Block 140g v2', name: 'Total Block 140g SPF 50', price: 32, stockQuantity: 0, inStock: false, image: '/images/Total Block 140g 50fps.jpg', brand: 'Yanbal', category: 'Body' },
      { id: 'BLQ-011', ref: 'Perfect Block', name: 'Perfect Block SPF 50', price: 29, stockQuantity: 0, inStock: false, image: '/images/Perfect Block FPS 50.jpg', brand: 'Esika', category: 'Facial' },
      { id: 'BLQ-012', ref: 'Perfect Block v2', name: 'Perfect Block FPS 50 Fresh', price: 29, stockQuantity: 0, inStock: false, image: '/images/bloqueador perfect block fps 50.jpg', brand: 'Esika', category: 'Facial' },
      { id: 'BLQ-013', ref: 'Ultraproteccion M1', name: 'Total Block Ultraproteccion Medium 1', price: 70, stockQuantity: 3, inStock: true, image: '/images/Total Block 80g 50fps.jpeg', brand: 'Yanbal', category: 'Body' },
      { id: 'BLQ-014', ref: 'Ultraproteccion M2', name: 'Total Block Ultraproteccion Medium 2', price: 70, stockQuantity: 1, inStock: true, image: '/images/Total Block 80g 50fps.jpeg', brand: 'Yanbal', category: 'Body' }
    ]
  },

  desodorantes: {
    title: 'Personal Care',
    description: 'Deodorants, talcum powders, and personal care essentials from Yanbal and Esika.',
    breadcrumb: 'Beauty',
    filterType: 'category',
    filters: ['All', 'Women', 'Men', 'Unisex'],
    products: [
      // Yanbal - XCG 12
      { id: 'DES-006', ref: 'Arom Absolute', name: 'Arom Absolute', price: 12, stockQuantity: 1, inStock: true, image: '/images/AROM_ABSOLUTE.jpg', brand: 'Yanbal', category: 'Men' },
      { id: 'DES-008', ref: 'Ccori Oro', name: 'Ccori Oro', price: 12, stockQuantity: 2, inStock: true, image: '/images/CCORI ORO deodorante.jpg', brand: 'Yanbal', category: 'Women' },
      { id: 'DES-009', ref: 'Ccori Rose', name: 'Ccori Rose', price: 12, stockQuantity: 1, inStock: true, image: '/images/deodorante corri rose.jpg', brand: 'Yanbal', category: 'Women' },
      { id: 'DES-EBF', ref: 'Efective Brisa Floral', name: 'Efective Brisa Floral', price: 12, stockQuantity: 2, inStock: true, image: '/images/EFECTIVE BRISA FLORAL.jpeg', brand: 'Yanbal', category: 'Women' },
      { id: 'DES-EOR', ref: 'Efective Original', name: 'Efective Original', price: 12, stockQuantity: 1, inStock: true, image: '/images/EFECTIVE ORIGINAL.jpg', brand: 'Yanbal', category: 'Unisex' },
      { id: 'DES-003', ref: 'Cielo', name: 'Cielo', price: 12, stockQuantity: 2, inStock: true, image: '/images/desodorante yanbal cielo.jpg', brand: 'Yanbal', category: 'Women' },
      { id: 'DES-GAI', ref: 'Gaia', name: 'Gaia', price: 12, stockQuantity: 2, inStock: true, image: '/images/GAIA.jpg', brand: 'Yanbal', category: 'Women' },
      { id: 'DES-OHM', ref: 'Ohm', name: 'Ohm', price: 12, stockQuantity: 2, inStock: true, image: '/images/OHM.jpg', brand: 'Yanbal', category: 'Men' },
      { id: 'DES-OHB', ref: 'Ohm Black', name: 'Ohm Black', price: 12, stockQuantity: 1, inStock: true, image: '/images/OHM BLACK.jpg', brand: 'Yanbal', category: 'Men' },
      { id: 'DES-OSA', ref: 'Osadia', name: 'Osadia', price: 12, stockQuantity: 2, inStock: true, image: '/images/OSADIA.jpg', brand: 'Yanbal', category: 'Women' },
      { id: 'DES-TMH', ref: 'Temptation Hombre', name: 'Temptation Hombre', price: 12, stockQuantity: 6, inStock: true, image: '/images/TEMPTATION HOMBRE.jpeg', brand: 'Yanbal', category: 'Men' },
      { id: 'DES-018', ref: 'Zentro', name: 'Zentro', price: 12, stockQuantity: 1, inStock: true, image: '/images/ZENTRO.jpg', brand: 'Yanbal', category: 'Men' },
      { id: 'DES-TMU', ref: 'Temptation Mujer', name: 'Temptation Mujer', price: 12, stockQuantity: 1, inStock: true, image: '/images/TEMPTATION HOMBRE.jpeg', brand: 'Yanbal', category: 'Women' },
      // Esika - XCG 10 (Magnat XCG 12)
      { id: 'DES-010', ref: 'Dorsay', name: 'Dorsay', price: 10, stockQuantity: 1, inStock: true, image: '/images/DORSAY.jpg', brand: 'Esika', category: 'Men' },
      { id: 'DES-005', ref: 'Fantasia Azul Infinito', name: 'Fantasia Azul Infinito', price: 10, stockQuantity: 1, inStock: true, image: '/images/FANTASIA AZUL INFINITO.jpg', brand: 'Esika', category: 'Women' },
      { id: 'DES-IYR', ref: 'Its You Roll-On', name: 'Its You Roll-On', price: 10, stockQuantity: 1, inStock: true, image: '/images/ITS YOU Roll-on.jpg', brand: 'Esika', category: 'Unisex' },
      { id: 'DES-IYL', ref: 'Its You Live', name: 'Its You Live', price: 10, stockQuantity: 1, inStock: true, image: '/images/ITS YOU LIVE.jpg', brand: 'Esika', category: 'Men' },
      { id: 'DES-014', ref: 'Leyenda Absute', name: 'Leyenda Absute', price: 10, stockQuantity: 2, inStock: true, image: '/images/LEYENDA.jpg', brand: 'Esika', category: 'Men' },
      { id: 'DES-015', ref: 'Magnat', name: 'Magnat', price: 12, stockQuantity: 2, inStock: true, image: '/images/MAGNAT.jpg', brand: 'Esika', category: 'Men' },
      { id: 'DES-MSL', ref: 'Magnat Select', name: 'Magnat Select', price: 10, stockQuantity: 1, inStock: true, image: '/images/MAGNAT select.jpg', brand: 'Esika', category: 'Men' },
      { id: 'DES-004', ref: 'Pulso', name: 'Pulso', price: 10, stockQuantity: 1, inStock: true, image: '/images/PULSO.jpg', brand: 'Esika', category: 'Men' },
      { id: 'DES-001', ref: '36H Total Sec Piel Delicada', name: '36H Total Sec Piel Delicada', price: 10, stockQuantity: 1, inStock: true, image: '/images/36H TOTAL SEC PIEL DELICADA.jpg', brand: 'Esika', category: 'Women' },
      { id: 'DES-002', ref: '36H Total Sec Neutro', name: '36H Total Sec Neutro', price: 10, stockQuantity: 1, inStock: true, image: '/images/36H TOTAL SEC NEUTRO.jpg', brand: 'Esika', category: 'Unisex' },
      // Desenredante & Talcos
      { id: 'DES-MCH', ref: 'Mini Chics', name: 'Mini Chics Desenredante', price: 10, stockQuantity: 2, inStock: true, image: '/images/MINI CHICS.png', brand: 'Esika', category: 'Unisex' },
      { id: 'DES-XTR', ref: 'Xtreme', name: 'Talcos Xtreme', price: 35, stockQuantity: 1, inStock: true, image: '/images/XTREME.jpg', brand: 'Esika', category: 'Unisex' }
    ]
  },
  ...
  'limpieza-facial': {
    ...
    products: [
      { id: 'LF-001', ref: 'Exfoliante', name: 'Exfoliante Triple Accion Max', price: 35, stockQuantity: 1, inStock: true, image: '/images/Exfoliante Triple Accion esika.jpg', brand: 'Esika', category: 'Exfoliators' },
      { id: 'LF-002', ref: 'Micelar Esika', name: 'Agua Micelar Triple Accion Max', price: 25, stockQuantity: 0, inStock: false, image: '/images/Agua Micelar Triple Accion esika.png', brand: 'Esika', category: 'Micellar Water' },
      { id: 'LF-003', ref: 'Tonica', name: 'Locion Tonica Essential 125ML', price: 45, stockQuantity: 1, inStock: true, image: '/images/Locion Tonica Essential lbel.jpg', brand: "L'Bel", category: 'Toners' },
      { id: 'LF-004', ref: 'Sensitiva Elixir', name: 'Sensitiva Elixir Toning Cleanser', price: 35, stockQuantity: 0, inStock: false, image: '/images/Sensitiva Elixir Toning Cleanser 120ml.jpg', brand: "L'Bel", category: 'Cleansers' },
      { id: 'LF-005', ref: 'Anti-Dark Spots', name: 'Anti-Dark Spots Facial Serum', price: 45, stockQuantity: 0, inStock: false, image: '/images/Anti-Dark Spots Facial Serum.jpg', brand: "L'Bel", category: 'Serums' },
      { id: 'LF-006', ref: 'Bifasico', name: 'Desmaquillador Essential Bifasico', price: 22, stockQuantity: 0, inStock: false, image: '/images/Desmaquillador Essential lbel.jpg', brand: "L'Bel", category: 'Cleansers' },
      { id: 'LF-007', ref: 'Micelar LBel', name: 'Agua Micelar 2 en 1', price: 25, stockQuantity: 0, inStock: false, image: '/images/Agua Micelar 2 en 1 lbel.jpg', brand: "L'Bel", category: 'Micellar Water' },
      { id: 'LF-008', ref: 'Nocturne', name: 'Nocturne Gel Limpiador Facial', price: 28, stockQuantity: 0, inStock: false, image: '/images/Nocturne Limpiadora lbel.jpg', brand: "L'Bel", category: 'Cleansers' },
      { id: 'LF-009', ref: 'Antioxidant', name: 'Antioxidant Concentrated Serum', price: 55, stockQuantity: 0, inStock: false, image: '/images/Antioxidant Concentrated Serum.jpg', brand: "L'Bel", category: 'Serums' }
    ]
  },
