/**
 * React Query hooks for CMS data fetching (Directus)
 *
 * Provides caching, automatic refetching, and loading states for all
 * CMS content types. Falls back to local productData when CMS is disabled.
 */
...
const USE_CMS = directusConfig.enabled;
